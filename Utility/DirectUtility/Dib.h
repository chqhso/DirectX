...
//extern float&	DibLoadHandle(std::string FileName);
//extern bool		DibSave(float& Dib, std::string FileName);
...
//extern float&	DibCreateEmpty(int nBitsPerPixel, int nWidth, int nHeight);
//extern float&	DibCreateEmptyHandle(int nBitsPerPixel, int nWidth, int nHeight);
//extern void		DibDeleteHandle(float& lpSrc);
...
//extern float&	DibDuplicate(float& lpSrc);
//extern float&	DibDuplicateHandle(float& lpSrc);
//extern bool		DibCopyRect(float& lpDstDib, int dstx, int dsty, float& lpSrcDib, float 
